...
export default function Quiz({
  ...
  return (
    <BackgroundBeamsWithCollision className={isSubmitted ? "" : "h-[100dvh] overflow-hidden"}>
      <div className={`relative z-10 w-full max-w-4xl mx-auto p-4 md:p-8 ${isSubmitted ? "" : "h-full flex items-center justify-center"}`}>
                    ...
                    {!isSubmitted ? (
                      ...
                      <div className="space-y-8">
                        ...
                        <div className="space-y-12">
                          <QuizReview questions={questions} userAnswers={answers.filter((answer): answer is string => answer !== null)} />
                        </div>
